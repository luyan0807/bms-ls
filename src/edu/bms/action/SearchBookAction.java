...
public class SearchBookAction extends ActionSupport implements SessionAware,RequestAware{
	...
	public String showbook(){
        ...
        for (int i = 0; i <size; i++) {
        	System.out.println("barcode come in");
        ...
        bookCatalog=bookInfo.getBookCatalog();
        request.put("bookCatalog",bookCatalog );
        request.put("bookInfo", bookInfo);
        request.put("bookBarcodes", bookBarcodes);
		return "showbook";
    }
