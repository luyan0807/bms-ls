			...
			<form action="bookinfo" class="form-inline" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="form-group">
					 ...
					 <option value="Y-娱乐">Y-娱乐</option>
					 <option value="S-时尚">S-时尚</option>
					 <option value="S-生活">S-生活</option>
					 <option value="W-外语">W-外语</option>
					 <option value="K-考试">K-考试</option>
					 <option value="X-小说">X-小说</option>
					 <option value="Z-传记">Z-传记</option>
					 <option value="L-历史">L-历史</option>
				     <option value="Z-宗教">Z-宗教</option>
					 <option value="X-心理学">X-心理学</option>
					 <option value="S-社会科学">S-社会科学</option>
